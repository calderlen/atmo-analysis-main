...
def make_alias(instrument="PEPSI", planet_name="KELT-20b", spectrum_type="transmission", temperature_profile="inverted-transmission-better", model_tag="alias", spec_one="Fe", vmr_one=5.39e-5, spec_two="Fe+", vmr_two=5.39e-5, arm='blue'):    
    """
